...
<link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.0/css/all.css" integrity="sha384-lZN37f5QGtY3VHgisS14W3ExzMWZxybE1SJSEsQp9S+oqd12jhcu+A56Ebc1zFSJ" crossorigin="anonymous">
    ...
    <body class="antialiased" style="background-image: linear-gradient(360deg, #f093fb 0%, #f5576c 70%);   background-size: cover; background-repeat: no-repeat; ">

<div class="container-fluid bg-light text-white ml-4 mt-2 mr-4" style="width:90%;" >
<div> 
    <a href="/showmaterial" class="btn btn-secondary mb-3 mt-2">Go Back</a>
</div>
<iframe src="/storage/assets/{{$data->file_name}}" style="width:100%;height:700px;"></iframe>
</div>    
    </body>
</html>